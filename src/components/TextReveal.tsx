...
const text =
  "We don't just build software. We craft digital legacies. Every pixel, every line of code is meticulously designed to elevate your brand and dominate the market.";
  ...
  return (
    <div className="relative w-full bg-white dark:bg-black">
      ...
      <div className="absolute top-0 left-0 w-full flex justify-center z-10">
        <div className="w-full max-w-7xl mx-4 sm:mx-6 md:mx-8 lg:mx-12 xl:mx-24 border-t-[2px] border-dotted border-black/20 dark:border-white/20" />
      </div>

      {/* Sticky Scroll Container */}
      <section
        ref={targetRef}
        className="h-[300vh] sm:h-[350vh] md:h-[400vh] relative"
      >
        <div className="sticky top-0 h-screen flex items-center justify-center px-4 sm:px-6 md:px-8 lg:px-12 xl:px-24 overflow-hidden">
          <motion.p
            style={{ scale, opacity: sectionOpacity }}
            className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tighter max-w-6xl leading-[1.15] flex flex-wrap gap-x-2 sm:gap-x-3 md:gap-x-4 lg:gap-x-5"
          >
            {words.map((word, i) => {
